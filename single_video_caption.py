...
def create_cinematic_video(video_paths, captions_list, output_path):
    print(f"--- Processing {len(video_paths)} videos with {len(captions_list)} caption lines ---")
    ...
    final_video = CompositeVideoClip(
        [final_bg] + text_clips + [watermark_clip],
...
if __name__ == "__main__":
    ...
    if not categories:
        ...
        for category in categories:
            ...
            # File: result/health/health_final.mp4
